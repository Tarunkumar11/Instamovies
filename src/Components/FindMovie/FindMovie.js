        ...
        <div className="searched-movie container">
            ...
            <div className="second-part">
                ...
                <div className="next-page">
                    <ul>
                        <li onClick={() => {setPage((page) => {return Math.max(page-1 , 1)})}} ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" className="w-4 h-4 text-gray-7 dark:text-gray-7"><path fillRule="evenodd" d="M16.091 4.929l-7.057 7.078 7.057 7.064a1 1 0 01-1.414 1.414l-7.764-7.77a1 1 0 010-1.415l7.764-7.785a1 1 0 111.415 1.414z" clipRule="evenodd"></path></svg></li>
